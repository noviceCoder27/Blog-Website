...
export const Form = ({email,setEmail,password,setPassword,signin}) => {
    ...
    return (
        <form className="flex flex-col items-center max-lg:justify-center max-lg:min-h-[80vh]">
            ...
            <input type = "password" name = "password" value = {password} onChange = {(e) => {setPassword(e.target.value)}} className="text-center min-w-[30vw] bg-[#eeeeee] p-2 py-3 border-black border-4 rounded-[50px] font-monsterrat text-lg font-bold mb-4 lg:flex-1" placeholder="Enter your password"/>
